...
func (app *application) routes() http.Handler {
	...
	r.Handler(http.MethodGet, "/", dynamic.ThenFunc(app.handleHomePageWithPagination))
	// r.Handler(http.MethodGet, "/pagination", dynamic.ThenFunc(app.handleHomePageWithPagination))
	...
	r.Handler(http.MethodGet, "/profile/view/:id", dynamic.ThenFunc(app.handleProfileViewPage))
	...
	r.Handler(http.MethodDelete, "/listings/delete/:id/picture/:picture", protected.ThenFunc(app.handleDeletePicture))
